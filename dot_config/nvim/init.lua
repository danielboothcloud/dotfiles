...
-- Allow the cursor to move one position beyond the end of the line
...
require('lazy').setup({
  ...
  -- 'NMAC427/guess-indent.nvim', -- Detect tabstop and shiftwidth automatically (DISABLED: causes aggressive auto-indentation)
...
-- Set terminal title to show "vi - parent directory name"
vim.api.nvim_create_autocmd({ 'VimEnter', 'DirChanged' }, {
  callback = function()
    local cwd = vim.fn.getcwd()
    local parent_dir = vim.fn.fnamemodify(cwd, ':t')
    vim.opt.title = true
    vim.opt.titlestring = 'vi - ' .. parent_dir
  end,
})
